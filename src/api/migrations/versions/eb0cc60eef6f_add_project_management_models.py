...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_kanban_columns_project_id"),
        "kanban_columns",
        ["project_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_issues_assignee_id"), "issues", ["assignee_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_kanban_cards_column_id"), "kanban_cards", ["column_id"], unique=False
    )
