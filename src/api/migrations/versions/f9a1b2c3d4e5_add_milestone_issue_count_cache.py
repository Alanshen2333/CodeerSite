...
def upgrade() -> None:
    op.add_column('milestones', sa.Column('open_issues_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('milestones', sa.Column('closed_issues_count', sa.Integer(), nullable=False, server_default='0'))
