...
def downgrade() -> None:
    ...
    op.drop_constraint('ck_questions_view_count_nonnegative', 'questions', type_='check')
    op.drop_constraint('ck_questions_answer_count_nonnegative', 'questions', type_='check')
    op.drop_constraint('ck_questions_vote_count_nonnegative', 'questions', type_='check')
    op.drop_constraint('ck_users_reputation_nonnegative', 'users', type_='check')
    op.drop_constraint('ck_projects_next_issue_number_positive', 'projects', type_='check')
