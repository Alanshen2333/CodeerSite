...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_bookmarks_target_id"), "bookmarks", ["target_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_comments_target_type"), "comments", ["target_type"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_questions_author_id"), "questions", ["author_id"], unique=False
    )
    op.create_table(
        "votes",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_answers_author_id"), "answers", ["author_id"], unique=False
    )
    op.create_index(
